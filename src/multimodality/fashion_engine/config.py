...
class FashionConfig:
    ...
    chromadb_ref_dir: str = "/content/drive/MyDrive/멋쟁이사자처럼/project_final/chromadb"
    chromadb_war_dir: str = "/content/drive/MyDrive/멋쟁이사자처럼/project_final/chromadb_mycloset"
